...
| **W1-11a** | **✅ XONG (2026-09-03)** Accessibility audit bằng axe-core, 4 trang, 0 vi phạm sau khi sửa 4 lỗi contrast + 1 lỗi focus indicator | `PERFORMANCE-LF.md` | W1-5, W1-6, W1-7 | Thực tế: ~1h |
| **W1-11b** | **✅ XONG (2026-09-03)** Lighthouse trên trang chủ + trang tỉnh — tìm + sửa 2 bug thật (ảnh marker 14MB→211KB, LCP blur-up delay 3.2s). Trang tỉnh đạt ~80/100, trang chủ chấp nhận thấp hơn do MapLibre GL nặng cố hữu (ghi RISK R12) | `PERFORMANCE-LF.md` | W1-10 | Thực tế: ~2h |
