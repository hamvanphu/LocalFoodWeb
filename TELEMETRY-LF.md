...
| **Món đã phân loại `mealTypes`** | **197/197** | `pnpm check:meal` |
| **Bể gợi ý bữa trưa** | **121** (61% của 197) | `pnpm check:meal` |
...
> thúc**, chứ không hỏi giữa chừng — đúng loại lỗi "đo trong khoảng đang đo" đã ghi ở mục 1.
>
